...
namespace Team_E_FIRE_Data_Processing_Program_BBB
{
    class eStrike
    {
       ...
       public
            ...
            long time; //the time at which the diode was struck (starting from the first electron detection)
            int diodeNumber; //the ID number of the diode struck by an electron
            long energy; //energy of the electron that impacted the diode

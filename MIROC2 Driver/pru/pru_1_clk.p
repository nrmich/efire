...
// ..
// R25: TRIGGER_DET_2, This is used for purely finding ADDR, but can probably be merged with R20. I'll confirm this on the actual BBB.
// ..
...
START:	// Only run once
	...
	ZERO &r25, 4 // Clears R25 just in case

MAINLOOP:
	//MOV r25, 0	// Tell PRU0 there is no trigger
	//XOUT XID_SCRATCH_1, r25, 4
	...
	// Determine which CLK to use for this conversion
	XOUT XID_SCRATCH_1, r25, 4	// Write r20 to scratchpad

	QBEQ EMPTY, r25.w0, 0	// Clear ADDR pins if there is no trigger.
